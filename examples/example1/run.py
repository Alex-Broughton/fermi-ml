...
(2) Run one simluation using multitest.sub (this will be sim 0), running a full
    ...
    along the way. Ensure that lines 176-179, 319-325, and 336 are *commmented*.
    Notice that ltcube_00.fits has been generated inside .../sim_0.
...
(4) If that worked, yay! Go ahead and ensure that lines 176-179, 319-325, and 336 are
    *uncommmented*. Add the location of the ltcube_00.fits to line 319 as well as
...
def main(cmd_line):
    ...
    #ltcube = '/pub/abrought/fermi-ml/examples/example1/output/sim_0/ltcube_00.fits'
